import cv2
import numpy as np
from sampler_ds.Base_image_sampler_ds import Base_image_sampler_ds 

# класс примера иза датасета для классификации
class Class_image_sampler_ds(Base_image_sampler_ds):
    def __init__(self,
...
#        return video_aug, self._label#
        return super()._convert_im(video_aug, self._coef_normalize), self._label
